...
#define AUTOSUSPEND_DYNAMIC 	0x01  //Suspend on s0
#define AUTOSUSPEND_DYNAMIC_S3 	0x02  //Suspend on s3
...
struct usbnet {
	...
	u32 netDetach;  //Enable net detach
